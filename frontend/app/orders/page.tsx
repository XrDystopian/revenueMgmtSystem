...
export default function OrderLogPage() {
  ...
  // Derived value — calculated fresh on every render from form.amount/form.duration.
  // Not stored in state, since it's fully determined by other state (no useEffect needed).
